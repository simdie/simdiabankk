...
export const metadata: Metadata = {
  ...
  description: "Bank of Asia Online high-interest savings accounts — 4.75% p.a. with no lock-in.",
};
  ...
  return (
    <section className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          In the meantime, explore our current savings account details on the accounts page — earn 4.75% p.a. with no minimum balance and no lock-in.
        </p>
