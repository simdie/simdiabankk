...
export const metadata: Metadata = {
  title: "Careers at Bank of Asia",
  description: "Join Bank of Asia Online — we're hiring across engineering, risk, operations, and customer experience.",
};
  ...
  return (
    <section className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          We&apos;re growing fast and hiring across engineering, product, risk, compliance, and customer experience in Singapore, Hong Kong, and Sydney. Check back soon or contact us to express your interest.
        </p>
